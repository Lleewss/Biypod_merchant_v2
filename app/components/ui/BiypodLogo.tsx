...
const BiypodLogo = forwardRef<SVGSVGElement, LogoProps>(
  ({ className, variant = 'primary', size = 'md', color = 'primary', ...props }, ref) => {
    ...
    return (
      <svg
        ...
        viewBox="164.9988988917078 335.92891435516856 695.0011011082922 292.07108564483144"
        fill="currentColor"
...
BiypodLogo.displayName = 'BiypodLogo';
